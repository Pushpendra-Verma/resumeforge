...
export const iim2Template: ResumeTemplate = {
  ...
  description:
    "Classic serif B-school format with full-width section bars, per-role gray bars with inline dates, a four-column education grid and a contact footer. ATS-friendly.",
  tag: "Serif",
  accent: "#8a1c1c",
